...
export default {
  data() {
    return {
      ...
      userGender: null,
      userAddress: "",
      // userFirstName: this.$store.state.validateModule.userFirstName,
      // userEmail: this.$store.state.validateModule.userEmail,
      // userPassword: this.$store.state.validateModule.userPassword,
      // userPassword2: this.$store.state.validateModule.userPassword2,
      // userNumber: this.$store.state.validateModule.userNumber,
      // userGender: this.$store.state.validateModule.userGender,
      // userAddress: this.$store.state.validateModule.userAddress,
      ...
      // validateFirstName: this.$store.state.validateModule.validateFirstName,
      ...
      // validatePassword2: this.$store.state.validateModule.validatePassword2,
      // validateNumber: this.$store.state.validateModule.validateNumber,
      // validateAddress: this.$store.state.validateModule.validateAddress,
    };
  },
  methods: {
    goToLogIn() {
